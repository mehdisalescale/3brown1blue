...
Symbolic derivations + numerical finite-difference verification; gradient as direction of steepest ascent.
...
```bash
uv run --package phase-01-math jupyter lab projects/04-derivatives-and-chain-rule/notes.ipynb
```
