...
GD on Rosenbrock + paraboloid; visualize paths; vanilla / momentum / lr sweeps.
...
```bash
uv run --package phase-01-math jupyter lab projects/05-gradient-descent-by-hand/notes.ipynb
```
