...
ResNet-18 on CIFAR-10; skip connections, lr schedules, augmentation.
...
```bash
uv run --package phase-03-deep-learning jupyter lab projects/03-cifar-resnet/notes.ipynb
```
