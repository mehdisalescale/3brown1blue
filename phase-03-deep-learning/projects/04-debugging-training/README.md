...
Deliberately induce vanishing grads / exploding loss / label leak / bad init; diagnose.
...
```bash
uv run --package phase-03-deep-learning jupyter lab projects/04-debugging-training/notes.ipynb
```
