...
Scalar autograd à la Karpathy; train a tiny net through your own engine.
...
```bash
uv run --package phase-02-nn-from-scratch jupyter lab projects/04-micrograd/notes.ipynb
```
