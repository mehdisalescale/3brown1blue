...
Bigram → MLP language model on names dataset; train/val discipline.
...
```bash
uv run --package phase-02-nn-from-scratch jupyter lab projects/05-mini-makemore/notes.ipynb
```
