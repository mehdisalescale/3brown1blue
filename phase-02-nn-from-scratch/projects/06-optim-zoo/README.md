...
Implement SGD/momentum/RMSprop/Adam by hand; compare on a fixed task.
...
```bash
uv run --package phase-02-nn-from-scratch jupyter lab projects/06-optim-zoo/notes.ipynb
```
