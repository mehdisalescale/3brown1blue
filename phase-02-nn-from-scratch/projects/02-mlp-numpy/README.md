...
Full MLP with manual forward+backward; train on MNIST; match a PyTorch baseline.
...
```bash
uv run --package phase-02-nn-from-scratch jupyter lab projects/02-mlp-numpy/notes.ipynb
```
